...
const navigation = [
  ...
  { name: 'History', href: '/history', icon: ChartPieIcon, current: false },
]
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-indigo-600 px-4 pb-4">
            <div className="flex h-32 shrink-0 items-center">
              <img
                ...
                src="https://png.pngtree.com/png-vector/20230814/ourmid/pngtree-hello-kitty-with-a-bunch-of-sweets-in-the-center-clipart-vector-png-image_6862287.png"
                alt="Your Company"
              />
            </div>
